...
- Grava o arquivo de report atomicamente (`write tmp → mv`)
- Faz append da entrada correspondente em `reports[]` do run-state (CONTRACT-RUN-STATE-02)
- Faz append de evento no log JSONL do run
