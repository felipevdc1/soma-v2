...
5. **Baseline**: **1378 / 1370 / 5 / 3** em `c3019f7`. As 5 pré-existentes (`doctor drift`, `CC-07`, `phase4a-regression`, `AC-13 BLOCK_CONFLICT`, `SANDBOX_VIOLATION`) **não devem ser consertadas**. Meça antes e depois e reconcilie; nenhum fail NOVO fora dos seus.
